...
plt.plot(historico.history['loss'], label='Loss in Training Set')
plt.plot(historico.history['val_loss'], label='Loss in Validation Set')
plt.xlabel('period')
plt.ylabel('Loss')
...
plt.figure(figsize=(10, 6))
plt.scatter(dados['TempMed'], dados['Chuva'], s=20, c='blue', alpha=0.5, label='Rain')
plt.scatter(dados['TempMed'], dados['Evaporacao'], s=20, c='green', alpha=0.5, label='Evaporation')
plt.xlabel('Average temperature')
plt.ylabel('Values')
plt.title('Relationship between Average Temperature and Rain and Evaporation')
plt.legend()
plt.show()
